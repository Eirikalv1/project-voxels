...
pub fn gen_terrain(world_pos: Vec3) -> [VoxelType; CHUNK_SIZE_CUBED] {
    ...
    for pos1d in 0..CHUNK_SIZE_CUBED {
        ...
        let height = (noise.get([world_pos3d.x as f64 / FREQUENCY, 0.0, world_pos3d.z as f64 / FREQUENCY])
            * AMPLITUDE
            + AMPLITUDE / 2.0) as i32;
        chunk_data[to_1d(pos3d.x as f32, height as f32, pos3d.z as f32) as usize] =
            VoxelType::Block;
    }
